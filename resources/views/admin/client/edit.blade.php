      ...
      <div class="col-md-8 col-lg-6">
        <div class="um-card">
          <div class="um-card-header">
            <div>
              <h2 class="um-card-title">{{ __('client.client_info_name', ['name' => $viewData['client']->getName()]) }}
              </h2>
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ $viewData['client']->getName() }}" placeholder="{{ __('client.placeholder_name') }}">
                  @error('name')
                ...
                <div class="col-md-6">
                  ...
                  <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                    value="{{ $viewData['client']->getEmail() }}" placeholder="{{ __('client.placeholder_email') }}">
                  @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    <input type="string" name="phone" class="form-control @error('phone') is-invalid @enderror"
                      value="{{ $viewData['client']->getPhone() }}" placeholder="{{ __('client.placeholder_phone') }}">
                    @error('phone')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
