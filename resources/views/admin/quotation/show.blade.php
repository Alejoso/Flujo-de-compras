...
@section('content')
  <div class="pj-wrapper">
    ...
    <div class="um-header">
      ...
      <a href="{{ route('admin.quotation.versions', [$viewData['project']->getId(), $viewData['version']->getQuotation()->getId()]) }}"
    ...
    <div class="cot-header-card mb-4 text-center">
      ...
      <div class="cot-project-details justify-content-center mt-2">
        ...
        <span><i class="bi bi-calendar3 me-1"></i>{{ $viewData['version']->getCreatedAt() }}</span>
      </div>
    </div>
