// cotizacion-form.js
// Maneja el autocompletado de búsqueda de materiales y la tabla editable
// del formulario de crear/editar cotización.
//
// Configuración leída desde el contenedor #cotizacion-app:
//   data-search-url    – URL del endpoint de búsqueda de materiales
//   data-row-idx       – índice inicial de fila (0 en crear, count en editar)
//   data-has-empty-row – "1" cuando existe la fila de estado vacío (solo en crear)
